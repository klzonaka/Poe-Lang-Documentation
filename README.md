...
この場合、 ボックスが初期化されていないと、 ボックスの直下に値を代入してしまう **[ドロップ](https://github.com/klzonaka/Poe-Lang-Documentation/edit/main/README.md#%E3%83%89%E3%83%AD%E3%83%83%E3%83%97)** が発生します。 `$` や `#` キーワードでボックスを予め初期化してください。
